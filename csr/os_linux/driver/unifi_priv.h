...
#define CSR_WIFI_HIP_IS_STA_FW(mode) ((((mode) == CSR_WIFI_ROUTER_CTRL_MODE_STA) || \
					   ((mode) == CSR_WIFI_ROUTER_CTRL_MODE_P2PCLI) || \
					   ((mode) == CSR_WIFI_ROUTER_CTRL_MODE_P2P))  ? TRUE : FALSE)
...
#define UNIFI_MAX_MULTICAST_ADDRESSES 10
    ...
    struct sk_buff_head napi_skb_list;
...
CsrResult CsrWifiSdioQueueFlush(void);
...
#ifdef CSR_WIFI_NAPI_ENABLE
#define CSR_WIFI_NAPI_BUDGET 16

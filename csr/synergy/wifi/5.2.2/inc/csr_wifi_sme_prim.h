...
/*******************************************************************************
 ...
 VALUES
    ...
    CSR_WIFI_WPS_CONFIG_DISPLAY
                   - Display. This is qualified with physical or virtual display
    ...
    CSR_WIFI_WPS_CONFIG_PBC
                   - PBC. This is qualified with physical or virtual PBC
    CSR_WIFI_WPS_CONFIG_KEYPAD
                   - KeyPad
    CSR_WIFI_WPS_CONFIG_VIRTUAL_PBC
                   - Virtual PBC: PBC through software user interface
...
/*******************************************************************************
  ...
  MEMBERS
    coexFecMutualExclusionDisableOverride
                   - ***
                     On a dual antenna platform (unifiFECMutualExclusion = 0),
                     coexistence blackouts MAY only be applied if this flag is
                     set. On a single antenna platform this value will be
                     ignored.
                     ***
                     NOTE: This 'CsrWifiSmeCoexConfig' structure contains a set
                     of WLAN blackout and duration parameters, each appertaining
                     to a specific Bluetooth activity. Each one is specified as
                     an array of two values. On a single antenna platform the
                     value at index 0 is used and the value at index 1 is
                     ignored. On a dual antenna platform the value at index 1 is
                     used and the value at index 0 is ignored.
                     A value of zero for either the blackout duration or the
                     blackout period for a given Bluetooth activity implies that
                     no WLAN blackout will be applied for that Bluetooth
                     activity on the relevant platform.
                     For example if coexObexBlackoutDurationMs[1] is set to zero
                     then no WLAN blackout will be applied on a dual antenna
                     platform whilst Obex is active (even if
                     coexFecMutualExclusionDisableOverride is set).
                     Typical/default value TRUE
                     This should be changed to FALSE for a dual antenna platform
                     with GOOD RF isolation between the WLAN and Bluetooth
                     antennas. The 'FALSE' value will ensure that NO WLAN
                     blackouts will be issued during ANY Bluetooth activity
    coexEnableSchemeManagement
                   - Enables the Coexistence Management Scheme
                     Typical/default value FALSE
                     (This value applies to both a single antenna and a dual
                     antenna platform.)
    coexPeriodicWakeHost
                   - If TRUE the firmware wakes up the host periodically
                     according to the traffic period and latency parameters; the
                     host will then send the data to transmit only when woken up.
                     If FALSE, the firmware does not wake up the host and the
                     host will send the data to transmit to the firmware
                     whenever there is data to transmit
                     Typical/default value FALSE
                     (This value applies to both a single antenna and a dual
                     antenna platform.)
    coexTrafficBurstyLatencyMs
                   - Period of awakening for the firmware used when bursty
                     traffic is detected
                     Typical/default value 60
                     (This value applies to both a single antenna and a dual
                     antenna platform.)
    coexTrafficContinuousLatencyMs
                   - Period of awakening for the firmware used when continuous
                     traffic is detected
                     Typical/default value 10
                     (This value applies to both a single antenna and a dual
                     antenna platform.)
    coexBleAdvScanBlackoutDurationMs
                   - Blackout Duration when a  BLE discovery is in progress
                     Typical/default values {5, 0}
    coexBleAdvScanBlackoutPeriodMs
                   - Blackout Period when a BLE discovery is in progress
                     Typical/default values {100, 0}
    coexBleAdvScanContinuousBlackoutDurationMs
                   - Blackout Duration when a continuous BLE discovery is in
                     progress
                     Typical/default values {50, 0}
    coexBleAdvScanContinuousBlackoutPeriodMs
                   - Blackout Period when a continuous BLE discovery is in
                     progress
                     Typical/default values {100, 0}
    coexBleConnectionIntervalThreshold
                   - Upper limit for connection interval. No coex blackouts will
                     be used for intervals greater than this value.
                     Typical/default values {21, 0}
    coexBleConnectionBlackoutDurationMs
                   - Blackout Duration when a BLE Connection (using intermittent
                     scanning) is taking place
                     Typical/default values {5, 0}
    coexBleConnectionBlackoutPeriodMs
                   - Blackout Period when a BLE Connection (using intermittent
                     scanning) is taking place
                     Typical/default values {100, 0}
    coexBleConnectionContinuousBlackoutDurationMs
                   - Blackout Duration when a continuous BLE Connection attempt
                     is taking place
                     Typical/default values {50, 0}
    coexBleConnectionContinuousBlackoutPeriodMs
                   - Blackout Period when a continuous BLE Connection attempt is
                     taking place
                     Typical/default values {100, 0}
    coexEapolDurationMs
                   - Blackout Duration whilst Eapol is active
                     Typical/default values {20, 0}
    coexEapolPeriodMs
                   - Blackout Period whilst Eapol is active
                     Typical/default values {25, 0}
    coexNoaPeriodMs
                   - Period when Wifi is NOT active because a Noa is in progress
                     Typical/default values {5, 0}
    coexObexBlackoutDurationMs
                   - Blackout Duration when a Obex Connection is used
                     Typical/default values {20, 0}
    coexObexBlackoutPeriodMs
                   - Blackout Period when a Obex Connection is used
                     Typical/default values {40, 0}
    coexScoMaxBlackoutDurationUs
                   - Blackout Duration when a SCO Connection is used
                     Typical/default values {1250, 1250}
    coexeScoMaxBlackoutDurationUs
                   - Blackout Duration when a eSCO Connection is used
                     Typical/default values {2500, 1250}
    coexA2dpBrBlackoutDurationMs
                   - Blackout Duration when a Basic Rate A2DP Connection
                     streaming data
                     Typical/default values {75, 75}
    coexA2dpBrBlackoutPeriodMs
                   - Blackout Period when a Basic Rate A2DP Connection streaming
                     data
                     Typical/default values {95, 95}
    coexA2dpEdrBlackoutDurationMs
                   - Blackout Duration when an Enhanced Data Rate A2DP
                     Connection streaming data
                     Typical/default values {55, 0}
    coexA2dpEdrBlackoutPeriodMs
                   - Blackout Period when an Enhanced Data Rate A2DP Connection
                     streaming data
                     Typical/default values {95, 0}
    coexPagingBlackoutDurationMs
                   - Blackout Duration when a BT page is active
                     Typical/default values {90, 0}
    coexPagingBlackoutPeriodMs
                   - Blackout Period when a BT page is active
                     Typical/default values {95, 0}
    coexInquiryBlackoutDurationMs
                   - Blackout Duration when a BT inquiry is active
                     Typical/default values {65, 0}
    coexInquiryBlackoutPeriodMs
                   - Blackout Period when a BT inquiry is active
                     Typical/default values {95, 0}

*******************************************************************************/
typedef struct
{
    CsrBool   coexFecMutualExclusionDisableOverride;
    ...
    CsrUint16 coexBleAdvScanBlackoutDurationMs[2];
    CsrUint16 coexBleAdvScanBlackoutPeriodMs[2];
    CsrUint16 coexBleAdvScanContinuousBlackoutDurationMs[2];
    CsrUint16 coexBleAdvScanContinuousBlackoutPeriodMs[2];
    CsrUint16 coexBleConnectionIntervalThreshold[2];
    CsrUint16 coexBleConnectionBlackoutDurationMs[2];
    CsrUint16 coexBleConnectionBlackoutPeriodMs[2];
    CsrUint16 coexBleConnectionContinuousBlackoutDurationMs[2];
    CsrUint16 coexBleConnectionContinuousBlackoutPeriodMs[2];
    CsrUint16 coexEapolDurationMs[2];
    CsrUint16 coexEapolPeriodMs[2];
    CsrUint16 coexNoaPeriodMs[2];
    CsrUint16 coexObexBlackoutDurationMs[2];
    CsrUint16 coexObexBlackoutPeriodMs[2];
    CsrUint16 coexScoMaxBlackoutDurationUs[2];
    CsrUint16 coexeScoMaxBlackoutDurationUs[2];
    CsrUint16 coexA2dpBrBlackoutDurationMs[2];
    CsrUint16 coexA2dpBrBlackoutPeriodMs[2];
    CsrUint16 coexA2dpEdrBlackoutDurationMs[2];
    CsrUint16 coexA2dpEdrBlackoutPeriodMs[2];
    CsrUint16 coexPagingBlackoutDurationMs[2];
    CsrUint16 coexPagingBlackoutPeriodMs[2];
    CsrUint16 coexInquiryBlackoutDurationMs[2];
    CsrUint16 coexInquiryBlackoutPeriodMs[2];
} CsrWifiSmeCoexConfig;
...
/*******************************************************************************
  ...
  MEMBERS
    ...
    deviceNameLength         - deviceNameLen. Up to 32 characters without \0.
    manufacturer             - manufacturer: CSR
    manufacturerLength       - manufacturerLen. Up to 64 characters without \0.
    modelName                - modelName Unifi
    modelNameLength          - modelNameLen. Up to 32 characters without \0.
    modelNumber              - modelNumber
    modelNumberLength        - modelNumberLen. Up to 32 characters without \0.
    serialNumber             - serialNumber. 32 characters without \0.
    primDeviceType           - Primary WPS device type
    secondaryDeviceTypeCount - Number of secondary device types
...
#define CSR_WIFI_SME_RESERVED06_REQ                       ((CsrWifiSmePrim) (0x0006 + CSR_WIFI_SME_PRIM_DOWNSTREAM_LOWEST))
#define CSR_WIFI_SME_RESERVED07_REQ                       ((CsrWifiSmePrim) (0x0007 + CSR_WIFI_SME_PRIM_DOWNSTREAM_LOWEST))
...
#define CSR_WIFI_SME_PRIM_DOWNSTREAM_HIGHEST           (0x0038 + CSR_WIFI_SME_PRIM_DOWNSTREAM_LOWEST)
...
#define CSR_WIFI_SME_RESERVED8008_CFM                     ((CsrWifiSmePrim)(0x0008 + CSR_WIFI_SME_PRIM_UPSTREAM_LOWEST))
#define CSR_WIFI_SME_RESERVED8009_CFM                     ((CsrWifiSmePrim)(0x0009 + CSR_WIFI_SME_PRIM_UPSTREAM_LOWEST))
...
/*******************************************************************************
  ...
  NAME
    CsrWifiSmeReserved06Req

  DESCRIPTION
    This primitive is dummied as a reserved entry.

...
*******************************************************************************/
#define CsrWifiSmeReserved06ReqCreate(msg__, dst__, src__) \
    msg__ = (CsrWifiSmeReserved06Req *) CsrPmemAlloc(sizeof(CsrWifiSmeReserved06Req)); \
    CsrWifiFsmEventInit(&msg__->common, CSR_WIFI_SME_PRIM, CSR_WIFI_SME_RESERVED06_REQ, dst__, src__);

#define CsrWifiSmeReserved06ReqSendTo(dst__, src__) \
    { \
        CsrWifiSmeReserved06Req *msg__; \
        CsrWifiSmeReserved06ReqCreate(msg__, dst__, src__); \
        CsrMsgTransport(dst__, CSR_WIFI_SME_PRIM, msg__); \
    }

#define CsrWifiSmeReserved06ReqSend(src__) \
    CsrWifiSmeReserved06ReqSendTo(CSR_WIFI_SME_LIB_DESTINATION_QUEUE, src__)

/*******************************************************************************

  NAME
    CsrWifiSmeReserved07ReqSend
...
*******************************************************************************/
#define CsrWifiSmeReserved07ReqCreate(msg__, dst__, src__) \
    msg__ = (CsrWifiSmeReserved07Req *) CsrPmemAlloc(sizeof(CsrWifiSmeReserved07Req)); \
    CsrWifiFsmEventInit(&msg__->common, CSR_WIFI_SME_PRIM, CSR_WIFI_SME_RESERVED07_REQ, dst__, src__);

#define CsrWifiSmeReserved07ReqSendTo(dst__, src__) \
    { \
        CsrWifiSmeReserved07Req *msg__; \
        CsrWifiSmeReserved07ReqCreate(msg__, dst__, src__); \
        CsrMsgTransport(dst__, CSR_WIFI_SME_PRIM, msg__); \
    }

#define CsrWifiSmeReserved07ReqSend(src__) \
    CsrWifiSmeReserved07ReqSendTo(CSR_WIFI_SME_LIB_DESTINATION_QUEUE, src__)

/*******************************************************************************

  NAME
    CsrWifiSmeReserved8008CfmSend
...
*******************************************************************************/
#define CsrWifiSmeReserved8008CfmCreate(msg__, dst__, src__) \
    msg__ = (CsrWifiSmeReserved8008Cfm *) CsrPmemAlloc(sizeof(CsrWifiSmeReserved8008Cfm)); \
    CsrWifiFsmEventInit(&msg__->common, CSR_WIFI_SME_PRIM, CSR_WIFI_SME_RESERVED8008_CFM, dst__, src__);

#define CsrWifiSmeReserved8008CfmSendTo(dst__, src__) \
    { \
        CsrWifiSmeReserved8008Cfm *msg__; \
        CsrWifiSmeReserved8008CfmCreate(msg__, dst__, src__); \
        CsrSchedMessagePut(dst__, CSR_WIFI_SME_PRIM, msg__); \
    }

#define CsrWifiSmeReserved8008CfmSend(dst__) \
    CsrWifiSmeReserved8008CfmSendTo(dst__, CSR_WIFI_SME_IFACEQUEUE)

/*******************************************************************************

  NAME
    CsrWifiSmeReserved8009CfmSend
...
*******************************************************************************/
#define CsrWifiSmeReserved8009CfmCreate(msg__, dst__, src__) \
    msg__ = (CsrWifiSmeReserved8009Cfm *) CsrPmemAlloc(sizeof(CsrWifiSmeReserved8009Cfm)); \
    CsrWifiFsmEventInit(&msg__->common, CSR_WIFI_SME_PRIM, CSR_WIFI_SME_RESERVED8009_CFM, dst__, src__);

#define CsrWifiSmeReserved8009CfmSendTo(dst__, src__) \
    { \
        CsrWifiSmeReserved8009Cfm *msg__; \
        CsrWifiSmeReserved8009CfmCreate(msg__, dst__, src__); \
        CsrSchedMessagePut(dst__, CSR_WIFI_SME_PRIM, msg__); \
    }

#define CsrWifiSmeReserved8009CfmSend(dst__) \
    CsrWifiSmeReserved8009CfmSendTo(dst__, CSR_WIFI_SME_IFACEQUEUE)

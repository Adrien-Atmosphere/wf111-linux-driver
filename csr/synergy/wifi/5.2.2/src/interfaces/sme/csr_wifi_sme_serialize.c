...
CsrSize CsrWifiSmeCoexConfigSetReqSizeof(void *msg)
{
    ...
    bufferSize += 1; /* CsrBool primitive->coexConfig.coexFecMutualExclusionDisableOverride */
    ...
    bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexTrafficContinuousLatencyMs */
    {
        ...
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleAdvScanBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleAdvScanBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleAdvScanContinuousBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleAdvScanContinuousBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleConnectionIntervalThreshold[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleConnectionBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleConnectionBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleConnectionContinuousBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexBleConnectionContinuousBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexEapolDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexEapolPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexNoaPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexObexBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexObexBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexScoMaxBlackoutDurationUs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexeScoMaxBlackoutDurationUs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexA2dpBrBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexA2dpBrBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexA2dpEdrBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexA2dpEdrBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexPagingBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexPagingBlackoutPeriodMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexInquiryBlackoutDurationMs[2] */
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            bufferSize += 2; /* CsrUint16 primitive->coexConfig.coexInquiryBlackoutPeriodMs[2] */
        }
    }
    return bufferSize;
}
...
CsrUint8* CsrWifiSmeCoexConfigSetReqSer(CsrUint8 *ptr, CsrSize *len, void *msg)
{
    ...
    *len = 0;
    CsrUint16Ser(ptr, len, primitive->common.type);
    CsrUint8Ser(ptr, len, (CsrUint8) primitive->coexConfig.coexFecMutualExclusionDisableOverride);
    ...
    CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexTrafficContinuousLatencyMs);
    {
        ...
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleAdvScanBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleAdvScanBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleAdvScanContinuousBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleAdvScanContinuousBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleConnectionIntervalThreshold[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleConnectionBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleConnectionBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleConnectionContinuousBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexBleConnectionContinuousBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexEapolDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexEapolPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexNoaPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexObexBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexObexBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexScoMaxBlackoutDurationUs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexeScoMaxBlackoutDurationUs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexA2dpBrBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexA2dpBrBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexA2dpEdrBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexA2dpEdrBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexPagingBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexPagingBlackoutPeriodMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexInquiryBlackoutDurationMs[i2]);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Ser(ptr, len, (CsrUint16) primitive->coexConfig.coexInquiryBlackoutPeriodMs[i2]);
        }
    }
    return(ptr);
}
...
void* CsrWifiSmeCoexConfigSetReqDes(CsrUint8 *buffer, CsrSize length)
{
    ...
    CsrUint16Des(&primitive->common.type, buffer, &offset);
    CsrUint8Des((CsrUint8 *) &primitive->coexConfig.coexFecMutualExclusionDisableOverride, buffer, &offset);
    ...
    CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexTrafficContinuousLatencyMs, buffer, &offset);
    {
        ...
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleAdvScanBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleAdvScanBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleAdvScanContinuousBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleAdvScanContinuousBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleConnectionIntervalThreshold[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleConnectionBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleConnectionBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleConnectionContinuousBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexBleConnectionContinuousBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexEapolDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexEapolPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexNoaPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexObexBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexObexBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexScoMaxBlackoutDurationUs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexeScoMaxBlackoutDurationUs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexA2dpBrBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexA2dpBrBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexA2dpEdrBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexA2dpEdrBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexPagingBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexPagingBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexInquiryBlackoutDurationMs[i2], buffer, &offset);
        }
    }
    {
        CsrUint16 i2;
        for (i2 = 0; i2 < 2; i2++)
        {
            CsrUint16Des((CsrUint16 *) &primitive->coexConfig.coexInquiryBlackoutPeriodMs[i2], buffer, &offset);
        }
    }
